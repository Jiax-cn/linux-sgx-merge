...
#define DATE "built on: Sat Oct 22 13:36:45 2022 UTC"
...
static const char compiler_flags[] = {
    ...
    'a','c','k',' ','-','W','a','l','l',' ','-','O','3',' ','-','i',
    'n','c','l','u','d','e','/','h','o','m','e','/','j','i','a','x',
    '/','D','e','s','k','t','o','p','/','l','i','n','u','x','-','s',
    'g','x','-','m','e','r','g','e','/','e','x','t','e','r','n','a',
    'l','/','d','c','a','p','_','s','o','u','r','c','e','/','Q','u',
